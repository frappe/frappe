...
function onCreate(query: string) {
  console.log('create', { doctype: props.field.options, fieldname: props.field.fieldname, query })
...
function onRedirect(name: string) {
  console.log('redirect', { doctype: props.field.options, fieldname: props.field.fieldname, name })
}
