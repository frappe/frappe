...
// 			nts.call("nts.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/nts.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/nts.model.utils.user_settings.save')
