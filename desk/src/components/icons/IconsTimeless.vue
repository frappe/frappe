<template>
	...
	>
		...
		<symbol viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" id="icon-select">
			<path
				d="M4.5 3.636L6.136 2l1.637 1.636M4.5 8.364L6.136 10l1.637-1.636"
				stroke-linecap="round"
				stroke-linejoin="round"
			></path>
		</symbol>
		...
		>
			<path
				d="M2.5 9.5L9.5 2.5M9.50002 8V2.5H4.00002"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
		</symbol>
		...
		>
			<path
				d="M9.5 2.5L2.5 9.5M2.49999 4L2.49998 9.5L7.99998 9.5"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
		</symbol>
		...
		<symbol viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" id="icon-expand">
			<path
				d="M10 2L6.844 5.158M7.053 2h2.948v2.948M5.158 6.842L2 10m0-2.947V10h2.947"
				stroke-miterlimit="10"
				stroke-linecap="round"
				stroke-linejoin="round"
			></path>
		...
		<symbol viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg" id="icon-both">
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
				d="M6 2l3 3H3l3-3zm3 5l-3 3-3-3h6z"
				fill="#112B42"
			></path>
		</symbol>
		...
		<symbol viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="icon-table_2">
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
				d="M2.5 3.722c0-.454.316-.722.59-.722h9.82c.274 0 .59.268.59.722V5h-11V3.722zM1.5 5.5V3.722C1.5 2.826 2.16 2 3.09 2h9.82c.93 0 1.59.826 1.59 1.722v8.556c0 .896-.66 1.722-1.59 1.722H3.09c-.93 0-1.59-.826-1.59-1.722V5.5zm1 3.5V6h3v3h-3zm0 1v2.278c0 .454.316.722.59.722H5.5v-3h-3zm4 3h3v-3h-3v3zm4 0h2.41c.274 0 .59-.268.59-.722V10h-3v3zm3-4V6h-3v3h3zm-4 0h-3V6h3v3z"
				fill="#12283A"
				stroke="none"
			></path>
		</symbol>
		...
		<symbol viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="icon-table">
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
				d="M2.5 3.722c0-.454.316-.722.59-.722H5.2v2.7H2.5V3.722zm0 2.978v2.6h2.7V6.7H2.5zm0 3.6h2.7V13H3.09c-.274 0-.59-.268-.59-.722V10.3zM6.2 13h6.71c.274 0 .59-.268.59-.722V10.3H6.2V13zm7.3-3.7V6.7H6.2v2.6h7.3zm0-3.6V3.722c0-.454-.316-.722-.59-.722H6.2v2.7h7.3zm-12 4.1V3.722C1.5 2.826 2.16 2 3.09 2h9.82c.93 0 1.59.826 1.59 1.722v8.556c0 .896-.66 1.722-1.59 1.722H3.09c-.93 0-1.59-.826-1.59-1.722V9.8z"
				fill="#12283A"
				stroke="none"
			></path>
		</symbol>
		...
		>
			<path
				...
				fill-rule="evenodd"
				clip-rule="evenodd"
				d="M8.07685 1.45034H8.02155C7.13255 1.44218 6.2766 1.78707 5.64159 2.40938C5.00596 3.03229 4.64377 3.88215 4.63464 4.77206L4.63462 4.77206V4.77719V5.12175H3.75C2.64543 5.12175 1.75 6.01719 1.75 7.12175V12.5134C1.75 13.6179 2.64543 14.5134 3.75 14.5134H12.2885C13.393 14.5134 14.2885 13.6179 14.2885 12.5134V7.12175C14.2885 6.01718 13.393 5.12175 12.2885 5.12175H5.63462V4.77988C5.64166 4.156 5.89586 3.56033 6.34152 3.12359C6.78776 2.68627 7.38942 2.4441 8.01419 2.45031L8.01418 2.45034H8.01916H8.07417C8.69805 2.45738 9.29371 2.71158 9.73045 3.15724C9.92373 3.35446 10.2403 3.35766 10.4375 3.16438C10.6347 2.9711 10.6379 2.65453 10.4447 2.45731C9.82175 1.82169 8.97189 1.45949 8.08198 1.45036L8.08198 1.45034H8.07685ZM3.75 6.12175C3.19772 6.12175 2.75 6.56947 2.75 7.12175V12.5134C2.75 13.0656 3.19772 13.5134 3.75 13.5134H12.2885C12.8407 13.5134 13.2885 13.0656 13.2885 12.5134V7.12175C13.2885 6.56947 12.8407 6.12175 12.2885 6.12175H3.75ZM8.01936 10.3909C8.33605 10.3909 8.59279 10.1342 8.59279 9.81752C8.59279 9.50083 8.33605 9.24409 8.01936 9.24409C7.70266 9.24409 7.44593 9.50083 7.44593 9.81752C7.44593 10.1342 7.70266 10.3909 8.01936 10.3909ZM9.59279 9.81752C9.59279 10.6865 8.88834 11.3909 8.01936 11.3909C7.15038 11.3909 6.44593 10.6865 6.44593 9.81752C6.44593 8.94854 7.15038 8.24409 8.01936 8.24409C8.88834 8.24409 9.59279 8.94854 9.59279 9.81752Z"
				fill="#1F272E"
			/>
		</symbol>
		...
		<symbol id="icon-delete" viewBox="0 0 32 32" fill="none">
			<path
				...
				stroke-miterlimit="10"
				stroke-width="2"
				d="M7 7v18.118c0 2.145 1.492 3.882 3.333 3.882h11.333c1.842 0 3.333-1.737 3.333-3.882v-18.118"
			></path>
			<path
				stroke-linejoin="round"
				stroke-linecap="round"
			...
			<path
				...
				stroke-miterlimit="10"
				stroke-width="2"
				d="M10 7v-1c0-1.657 1.343-3 3-3h6c1.657 0 3 1.343 3 3v1"
			></path>
			<path
				stroke-linejoin="round"
				stroke-linecap="round"
		...
		<symbol
			id="icon-notification-with-indicator"
			viewBox="0 0 20 20"
			xmlns="http://www.w3.org/2000/svg"
		>
			<path
			...
			/>
			<path
				d="M14 6.75C15.5188 6.75 16.75 5.51878 16.75 4C16.75 2.48122 15.5188 1.25 14 1.25C12.4812 1.25 11.25 2.48122 11.25 4C11.25 5.51878 12.4812 6.75 14 6.75Z"
				fill="#FF5858"
				stroke="white"
				stroke-width="1.5"
			/>
		...
		<symbol viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="icon-message">
			...
			<mask id="a" fill="#fff">
				<path
					d="M8 13.001a19.4 19.4 0 0 1-1.427-.05 1.496 1.496 0 0 0 2.855 0c-.447.033-.922.05-1.428.05z"
				></path>
			</mask>
			<path
				d="M8 13.001a19.4 19.4 0 0 1-1.427-.05 1.496 1.496 0 0 0 2.855 0c-.447.033-.922.05-1.428.05z"
			...
			></path>
			<path
				d="M6.573 12.951l.073-.997-1.468-.108.44 1.405.955-.3zm2.855 0l.954.3.44-1.405-1.467.108.073.997zM8 12.001c-.483 0-.933-.016-1.354-.047L6.5 13.95c.474.035.974.052 1.501.052v-2zm-2.381 1.25c.159.507.475.95.904 1.265l1.184-1.612a.496.496 0 0 1-.18-.252l-1.908.599zm.904 1.265C6.95 14.83 7.469 15 8 15v-2a.496.496 0 0 1-.293-.096l-1.184 1.612zM8 15a2.5 2.5 0 0 0 1.478-.484l-1.184-1.612A.496.496 0 0 1 8 13v2zm1.478-.484c.429-.315.745-.758.904-1.265l-1.908-.599a.496.496 0 0 1-.18.252l1.184 1.612zm-.123-2.562c-.42.031-.871.047-1.355.047v2c.528 0 1.028-.017 1.502-.052l-.148-1.995z"
				fill="#12283A"
				mask="url(#a)"
			></path>
			<path
				d="M10.556 4.778a1.833 1.833 0 1 0 0-3.667 1.833 1.833 0 0 0 0 3.667z"
				fill="#FF5858"
				stroke="#FF5858"
			></path>
		</symbol>
		...
		<symbol viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" id="icon-comment">
			<path
				d="M14.2222 7.17042C14.2222 4.19205 11.4363 1.77783 7.99999 1.77783C4.56367 1.77783 1.77777 4.19205 1.77777 7.17042C1.77777 10.1488 4.56367 12.563 7.99999 12.563C8.43555 12.563 8.86032 12.5232 9.27099 12.4494L12.563 14.2223V10.8283C13.59 9.86672 14.2222 8.58411 14.2222 7.17042"
				stroke-miterlimit="10"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
		...
		>
			<path
				d="M10.596 2.046a.5.5 0 0 0-.707 0L6.937 5a.5.5 0 0 0 .707.707l2.099-2.099v8.126a.5.5 0 1 0 1 0V3.607l2.098 2.099a.5.5 0 0 0 .708-.707l-2.953-2.953z"
			/>
			<path
				d="M6.552 8.305v1H4.6V15.9a1 1 0 0 0 1 1h9.286a1 1 0 0 0 1-1V9.305h-1.953v-1h2.953V15.9a2 2 0 0 1-2 2H5.6a2 2 0 0 1-2-2V8.305h2.952z"
			/>
		</symbol>
		...
		>
			<path
				d="M8 14A6 6 0 108 2a6 6 0 000 12zM4 4l8 8"
				stroke-miterlimit="10"
				stroke-linecap="round"
				stroke-linejoin="round"
			></path>
		...
		<symbol id="icon-full-page" fill="none" viewBox="0 0 32 32">
			<path
				...
				stroke-miterlimit="10"
				stroke-width="2"
				d="M25 6h-18c-1.657 0-3 1.343-3 3v14c0 1.657 1.343 3 3 3h18c1.657 0 3-1.343 3-3v-14c0-1.657-1.343-3-3-3z"
			></path>
			<path
				stroke-linejoin="round"
				stroke-linecap="round"
			...
			<path
				...
				stroke-miterlimit="10"
				stroke-width="2"
				d="M19.272 10.364h4.364v4.364"
			></path>
		</symbol>

		<symbol xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="icon-crop">
			<path
				d="M14.88,11.63H4.33V1.12m7.34,10.51v3.25M6,4.37h5.64V10M1.13,4.37h3.2"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
		</symbol>
		...
		<symbol viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="icon-search">
			<path
				d="M7.389 12.278a4.889 4.889 0 1 0 0-9.778 4.889 4.889 0 0 0 0 9.778zM13.5 13.5l-2.658-2.658"
				stroke-linecap="round"
				stroke-linejoin="round"
			></path>
		</symbol>
		...
		<symbol viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="icon-list-alt">
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
				d="M2.5 3.722c0-.454.316-.722.59-.722h9.82c.274 0 .59.268.59.722v8.556c0 .454-.316.722-.59.722H3.09c-.274 0-.59-.268-.59-.722V3.722zM3.09 2c-.93 0-1.59.826-1.59 1.722v8.556c0 .896.66 1.722 1.59 1.722h9.82c.93 0 1.59-.826 1.59-1.722V3.722C14.5 2.826 13.84 2 12.91 2H3.09zM5 4.5a.5.5 0 0 0 0 1h4.002a.5.5 0 1 0 0-1H5zM5 7a.5.5 0 0 0 0 1h5.002a.5.5 0 1 0 0-1H5zm-.5 3a.5.5 0 0 1 .5-.5h2.27a.5.5 0 0 1 0 1H5a.5.5 0 0 1-.5-.5z"
				fill="#12283A"
				stroke="none"
			></path>
		</symbol>
		...
		<symbol viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="icon-image-view">
			<path
				d="M2.5 3.5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3h-3a1 1 0 0 1-1-1v-2zm0 7a1 1 0 0 1 1-1h3v3a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-2zm7-7a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-3v-3zm0 6h3a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-3z"
			></path>
		</symbol>
		...
		<symbol fill="none" xmlns="http://www.w3.org/2000/svg" id="icon-keyboard" viewBox="0 0 42 32">
			<path
				...
				stroke-miterlimit="4"
				stroke-width="2.4615"
				d="M7.385 2.462h27.077c2.719 0 4.923 2.204 4.923 4.923v17.231c0 2.719-2.204 4.923-4.923 4.923h-27.077c-2.719 0-4.923-2.204-4.923-4.923v-17.231c0-2.719 2.204-4.923 4.923-4.923z"
			></path>
			<path
				d="M12.8 11.323c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				d="M17.723 11.323c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				d="M15.262 16.246c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				d="M22.646 11.323c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				d="M20.185 16.246c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				d="M27.569 11.323c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				d="M25.108 16.246c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				d="M32.492 11.323c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				d="M30.031 16.246c0 0.816-0.661 1.477-1.477 1.477s-1.477-0.661-1.477-1.477c0-0.816 0.661-1.477 1.477-1.477s1.477 0.661 1.477 1.477z"
			></path>
			<path
				fill="none"
				stroke="currentColor"
		...
		<symbol viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" id="icon-assign">
			<path
				d="M8.80039 10H6.40039C5.33952 10 4.32211 10.4214 3.57196 11.1716C2.82182 11.9217 2.40039 12.9391 2.40039 14H9.60039"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
			<path
				d="M7.60029 7.6C9.14669 7.6 10.4003 6.3464 10.4003 4.8C10.4003 3.2536 9.14669 2 7.60029 2C6.0539 2 4.80029 3.2536 4.80029 4.8C4.80029 6.3464 6.0539 7.6 7.60029 7.6Z"
				stroke-linecap="round"
				stroke-linejoin="round"
			/>
		...
		<symbol fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="icon-customer">
			<g stroke="#4C5A67" stroke-miterlimit="10">
				<path
					d="M17.718 18.95c-.11-1.953-1.225-2.574-2.855-3.117-1.245-.415-1.588-1.722-1.682-2.416m-2.364-.001c-.092.69-.428 2-1.68 2.417-1.63.543-2.747 1.162-2.857 3.116"
				></path>
				<path
					d="M12 13.636a3.273 3.273 0 01-3.273-3.272v-.819a3.273 3.273 0 016.546 0v.819A3.273 3.273 0 0112 13.636z"
					stroke-linecap="square"
				></path>
		...
		<symbol
			...
			stroke="none"
			xmlns="http://www.w3.org/2000/svg"
			id="icon-share-people"
		>
			<path
				d="M10.633 2.8c-.474 0-.906.163-1.257.428a3.64 3.64 0 0 1 .734 2.19v.524c0 .5-.101.976-.283 1.41a2.095 2.095 0 0 0 2.902-1.933v-.524A2.095 2.095 0 0 0 10.632 2.8zm-4.12 5.761a2.619 2.619 0 0 1-2.618-2.619V5.42a2.619 2.619 0 0 1 5.237 0v.523a2.619 2.619 0 0 1-2.619 2.62zm7.179.474c-.672-.309-1.825-.736-3.058-.736-.626 0-1.23.11-1.763.26.197.04.394.082.591.132a3.642 3.642 0 0 1 2.72 3.274h1.594c.29 0 .524-.234.524-.523V9.986c0-.41-.236-.78-.608-.951z"
			></path>
			<path
				d="M10.703 13.013h-8.38a.524.524 0 0 1-.523-.524v-.249c0-1.191.8-2.24 1.954-2.534a11.25 11.25 0 0 1 2.76-.36c1.036 0 1.987.163 2.759.36a2.61 2.61 0 0 1 1.954 2.534v.25a.524.524 0 0 1-.524.523z"
			></path>
		</symbol>
		...
		>
			...
			<path
				...
				stroke-linecap="round"
				stroke-width=".7"
				d="M5.53911 7.55204h2.60407M5.25 8.83237h2.60407M6.49749 6.67866l-.82364 3.07385M7.79075 6.67866l-.82364 3.07385"
			/>
		</symbol>
		...
		<symbol viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" stroke="none" id="icon-help">
			<path
				...
				stroke-linejoin="round"
				stroke-miterlimit="10"
				d="M8.208 8.115v-.099a2.021 2.021 0 0 1 1.114-1.809l.057-.028a1.85 1.85 0 0 1 1.278-.142l.121.03c.623.156 1.1.659 1.223 1.289v0c.04.208.04.421 0 .63l-.029.153a1.805 1.805 0 0 1-.97 1.276l-.2.1a1.446 1.446 0 0 0-.804 1.297v0L10 11.5"
			/>
			<path
				fill="#20272E"
				stroke="currentColor"
		...
		<symbol viewBox="0 0 26 26" xmlns="http://www.w3.org/2000/svg" id="icon-edit-round">
			...
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
				d="M16.305 7.62c-.192.08-.367.197-.515.345l-.612.612 2.244 2.245.613-.612a1.586 1.586 0 0 0-1.73-2.59zm.41 3.91l-2.244-2.246-6.163 6.163a.5.5 0 0 0-.128.222l-.67 2.452a.3.3 0 0 0 .37.368l2.451-.669a.5.5 0 0 0 .222-.129l6.162-6.162z"
				fill="#70818F"
				stroke="none"
			></path>
		</symbol>
		...
		>
			...
			<g clip-path="url(#clip0)">
				<path
					d="M19.41 10.93a.687.687 0 0 0-.606-.361h-3.208l1.123-3.93a.687.687 0 0 0-.66-.874h-4.804c-.31 0-.58.207-.662.505l-2.06 7.55a.686.686 0 0 0 .663.866h3.296l-1.226 6.74a.686.686 0 0 0 1.247.504l6.863-10.294a.688.688 0 0 0 .033-.705z"
					fill="#fff"
				></path>
			</g>
			<defs>
		...
		>
			...
			></path>
			<path
				d="M18.9 6.912v.963h.1a2 2 0 0 1 2 2V19a2 2 0 0 1-2 2H8.999A1.998 1.998 0 0 1 7 19V9.875a2 2 0 0 1 2-2h.45v-.963a.787.787 0 1 1 1.576 0v.963h6.3v-.963a.788.788 0 0 1 1.575 0z"
				fill="#fff"
			></path>
		...
		>
			...
			<g clip-path="url(#clip0)">
				...
				<path
					d="M12.8066 4.8562V9.67921L13.9896 10.2256L15.1725 9.67921V4.8562H12.8066Z"
					fill="white"
				/>
			</g>
			<defs>
				<clipPath id="clip0">
					<rect
						...
						height="18.2175"
						fill="white"
						transform="translate(7.48242 4.8562)"
					/>
				</clipPath>
			</defs>
		</symbol>
		...
		>
			...
			></path>
			<path
				d="M13.546 6.749a.5.5 0 0 1 .908 0l1.87 4.053 4.432.526a.5.5 0 0 1 .28.863l-3.276 3.03.87 4.378a.5.5 0 0 1-.735.534L14 17.953l-3.895 2.18a.5.5 0 0 1-.734-.534l.87-4.377-3.277-3.03a.5.5 0 0 1 .28-.864l4.433-.526 1.87-4.053z"
				fill="#fff"
			></path>
		</symbol>
		...
		<symbol
			...
			xmlns="http://www.w3.org/2000/svg"
			viewBox="0 0 46 40"
			id="icon-folder-normal-large"
		>
			<path
				d="M.245 16.22A2 2 0 012.233 14h41.534a2 2 0 011.987 2.22L43.52 36.44A4 4 0 0139.543 40H6.457a4 4 0 01-3.976-3.56L.245 16.22zM43.125 11V7a2 2 0 00-2-2H20.312a.5.5 0 01-.328-.123L14.657.245A1 1 0 0014.001 0H4.875a2 2 0 00-2 2v9a1 1 0 001 1h38.25a1 1 0 001-1z"
				fill="#A6B1B9"
			></path>
		</symbol>
		...
		<symbol fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 37 46" id="icon-file-large">
			<g fill="#A6B1B9">
				<path
					d="M22 10V1.04a.5.5 0 01.812-.39l13.075 10.46a.5.5 0 01-.312.89H24a2 2 0 01-2-2z"
				></path>
				<path
					fill-rule="evenodd"
					clip-rule="evenodd"
					d="M19 0a1 1 0 011 1v10a3 3 0 003 3h12a2 2 0 012 2v26a4 4 0 01-4 4H4a4 4 0 01-4-4V3a3 3 0 013-3h16zM8 37a1 1 0 100 2h21a1 1 0 100-2H8zm-1-7a1 1 0 011-1h21a1 1 0 110 2H8a1 1 0 01-1-1zm1-9a1 1 0 100 2h6a1 1 0 100-2H8z"
				></path>
			</g>
		</symbol>
