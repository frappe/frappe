...
def create_linked_contact(link_list, address):
	...
	contact.add_phone("+91 0000000000", is_primary=True)
...
class TestAddressesAndContacts(unittest.TestCase):
	def test_get_data(self):
		...
		for idx, link in enumerate(links_list):
			test_item = [link, 'test address line 1', 'test address line 2', 'Milan', None, None, 'Italy', 0, '_Test First Name', '_Test Last Name', '_Test Address-Billing', '+91 0000000000', None, None, None, None, None, None 'test_contact@example.com', 1]
