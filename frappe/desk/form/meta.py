...
class FormMeta(Meta):
	...
	def as_dict(self, no_nulls=False):
		...
		for k in ("__js", "__css", "__list_js", "__calendar_js", "__map_js",
			...
			"__form_grid_templates", "__listview_template", "__treeview_js"):
			d[k] = self.get(k)
	...
	def add_code(self):
		...
		self._add_code(_get_path(self.name + '_treeview.js'), '__treeview_js')
		...
		self.add_code_via_hook("doctype_treeview_js", "__treeview_js")
