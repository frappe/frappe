...
def make_administrative_areas(administrative_areas):
	...
	if administrative_areas.has_key(country):
		country_record = {
		...
		"""
		uncomment in below block to use get_administrative_area_parent_name_alternative() function
		...
		for record in administrative_areas[country]:
			...
			record.update({
				"doctype": "Administrative Area",
				"parent_administrative_area": get_administrative_area_parent_name(country, record, administrative_areas[country], administrative_areas_copy[country]),
				#"parent_administrative_area": get_administrative_area_parent_name_alternative(parents, parent_administrative_area_type),
				"is_group": 1
			})
			del record['parent']
...
def get_administrative_area_parent_name(country, record, administrative_areas, administrative_areas_copy):
...
def get_administrative_area_parent_name_alternative(parents, parent_administrative_area_type):
	"""
