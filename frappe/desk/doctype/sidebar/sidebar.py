...
class Sidebar(Document, DeskViews):
	...
	def validate(self):
		...
		# The URL rules are desk v1's: a v2 layer is reached by its address, never by its
		# title's slug, and its title is shared with the other layers of the same sidebar.
		if not self.is_addressed:
