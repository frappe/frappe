...
class TestSchedulerHealthStatus(UnitTestCase):
	...
	@patch(f"{HEALTH_REPORT_MODULE}.is_scheduler_process_running", return_value=True)
	...
	@patch(f"{HEALTH_REPORT_MODULE}.get_scheduler_status", return_value={"status": "active"})
	@patch(f"{HEALTH_REPORT_MODULE}.is_scheduler_process_running", return_value=False)
	...
	@patch(f"{HEALTH_REPORT_MODULE}.get_scheduler_status", return_value={"status": "active"})
	@patch(
		f"{HEALTH_REPORT_MODULE}.is_scheduler_process_running",
