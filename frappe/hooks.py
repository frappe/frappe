...
scheduler_events = {
	...
	"hourly": [
		...
		"frappe.desk.form.doc_subscription.send_hourly_updates"
	],
	"daily": [
		...
		"frappe.desk.form.doc_subscription.send_daily_updates"
	],
	"daily_long": [
	...
	"weekly_long": [
		...
		"frappe.desk.form.doc_subscription.send_weekly_updates"
	],
	"monthly": [
