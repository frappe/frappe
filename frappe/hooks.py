...
scheduler_events = {
	...
	"daily_long": [
		...
		"frappe.integrations.doctype.nextcloud_settings.nextcloud_settings.daily_backup",
	],
	"weekly_long": [
		...
		"frappe.integrations.doctype.nextcloud_settings.nextcloud_settings.weekly_backup"
	],
	"monthly": [
