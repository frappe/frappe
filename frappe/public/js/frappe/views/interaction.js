...
frappe.views.InteractionComposer = class InteractionComposer {
	...
	get_fields() {
		...
		let fields = [
			...
			{ label: __("Start date"), fieldtype: "Datetime", fieldname: "start_date" },
			{ fieldtype: "Column Break" },
			{ label: __("End date"), fieldtype: "Datetime", fieldname: "due_date" },
			...
			{ fieldtype: "Section Break" },
			{ label: __("Sync with Google Calendar"), fieldtype: "Check", fieldname: "sync_with_google_calendar", default: "1" },
			{ fieldtype: "Column Break" },
			{
				label: __("Select Google Calendar"),
				fieldtype: "Link",
...
function get_doc_mappings() {
	const doc_map = {
		...
		ToDo: {
			...
			hidden_fields: ["public", "category", "start_date", "sync_with_google_calendar", "google_calendar"],
		},
	};
