...
frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
	...
	async render_report_jinja(print_settings, print_format) {
		// matches render_report_letterhead: an unnamed letter head means none at all
		const letterhead = print_settings.with_letter_head
			? print_settings.letter_head_name || null
			: null;
		const r = await frappe.call({
