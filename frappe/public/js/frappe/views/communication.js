...
frappe.views.CommunicationComposer = Class.extend({
	...
	get_fields: function() {
		return [
			...
			{label:__("Attach PDF Print"), fieldtype:"Check",
				fieldname:"attach_document_print"},
			{label:__("Attach Excel Spreadsheet"), fieldtype:"Check",
				fieldname:"attach_document_print_excel"},
	...
	send_email: function(btn, form_values, selected_attachments, print_html, print_format) {
		...
		return frappe.call({
			...
			args: {
				...
				add_excel_attachment: form_values.attach_document_print_excel,
				_lang : me.lang_code
			},
			btn: btn,
			callback: function(r) {
