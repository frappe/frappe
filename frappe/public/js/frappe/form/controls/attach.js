frappe.ui.form.ControlAttach = class ControlAttach extends frappe.ui.form.ControlData {
	...
	set_upload_options() {
		...
		if (this.frm) {
			options.doctype = (this.frm.doctype==this.doctype) ? this.frm.doctype : this.doctype;
			options.docname = (this.frm.doctype==this.doctype) ? this.frm.docname : this.docname;
