...
function get_user_link(user) {
	...
	let user_display_text = frappe.utils.escape_html(user_info?.fullname || "");

	if (user_info?.user_type === "Bot") {
		user_display_text = __("{0} {1}", [
			user_display_text,
			frappe.utils.icon("bot", "sm", "", "vertical-align: top;"),
		]);
	}
