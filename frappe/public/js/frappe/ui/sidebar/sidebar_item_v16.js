frappe.provide("frappe.ui.v16_sidebar_item");
frappe.ui.v16_sidebar_item.TypeLink = class SidebarItem {
	constructor(opts) {
		this.item = opts.item;
	...
	make() {
		...
		this.wrapper = $(
			frappe.render_template("sidebar_item_v16", {
				item: this.item,
				path: this.path,
...
frappe.ui.v16_sidebar_item.TypeSectionBreak = class SectionBreakSidebarItem extends (
	frappe.ui.v16_sidebar_item.TypeLink
) {
	prepare(opts) {
...
frappe.ui.v16_sidebar_item.TypeSpacer = class SpacerItem extends (
	frappe.ui.v16_sidebar_item.TypeLink
) {
...
frappe.ui.v16_sidebar_item.TypeSidebarItemGroup = class SpacerItem extends (
	frappe.ui.v16_sidebar_item.TypeLink
) {
	constructor(item, items) {
		super(item);
...
frappe.ui.v16_sidebar_item.TypeButton = class SidebarButton extends (
	frappe.ui.v16_sidebar_item.TypeLink
) {
	constructor(item) {
		super(item);
