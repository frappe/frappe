...
frappe.ui.Graph = class Graph {
    constructor({
        ...
        console.log("summary values", this.summary_values);
    ...
    setup_count_average() {
        ...
        //     let upper_graph_bound = this.get_upper_limit_and_parts(this.y_values)[0];
        //     this.average_line = this.snap.g(
        //         this.snap.line(0, 0, this.width - 80, 0).attr({class: "average"}),
        //         this.snap.text(this.width - 80, 0, "AVERAGE").attr({
        //             dy: ".32em",
        //             class: "average-text"
        //         })
        //     ).attr({
        //         class: "tick",
        //         transform: `translate(0, ${100 - 100/(upper_graph_bound/this.average) })`
        //     });
        // }
    }
