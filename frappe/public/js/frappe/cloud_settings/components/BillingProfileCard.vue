...
<template>
	<div class="cloud-settings-card cloud-settings-stack">
		...
		<div v-if="!loaded" class="cloud-settings-state" style="min-height: 80px">
			{{ __("Loading") }}
		</div>
		<template v-else>
			<div class="cloud-settings-form">
				<div class="cloud-settings-form-grid">
					<div class="cloud-settings-field">
						<label
							>{{ __("Legal name") }}
							<span class="cloud-settings-req">*</span></label
						>
						<input
				...
				<div class="cloud-settings-form-grid">
					<div class="cloud-settings-field">
						<label
							>{{ __("Country") }} <span class="cloud-settings-req">*</span></label
						>
						<input
					...
					<div class="cloud-settings-field">
						<label
							>{{ __("PIN / ZIP") }} <span class="cloud-settings-req">*</span></label
						>
						<input
				...
				<div class="cloud-settings-form-grid">
					<div class="cloud-settings-field" style="max-width: 160px">
						<label
							>{{ __("Currency") }} <span class="cloud-settings-req">*</span></label
						>
						<SelectMenu
