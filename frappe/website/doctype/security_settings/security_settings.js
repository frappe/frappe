...
frappe.ui.form.on("Security Settings", {
	refresh(frm) {
		$(frm.fields_dict.securitytxt_section.wrapper)
			.find(".section-body")
			.prepend(
				`<div class="alert alert-warning border d-flex justify-content-between align-items-center" style="flex: 0 0 100%; max-width: 100%; border-color: var(--border-color);">
