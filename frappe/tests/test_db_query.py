...
class TestDBQuery(IntegrationTestCase):
	...
	def test_child_table_field_syntax(self) -> None:
		note = frappe.get_doc(
			doctype="Note",
	...
	def test_child_table_join(self) -> None:
	...
	def test_link_field_syntax(self) -> None:
	...
	def test_build_match_conditions(self) -> None:
	...
	def test_string_as_field(self) -> None:
		self.assertEqual(
	...
	def test_between_filters(self) -> None:
	...
	def test_between_filters_date_bounds(self) -> None:
	...
	def test_ignore_permissions_for_get_filters_cond(self) -> None:
		frappe.set_user("test2@example.com")
	...
	def test_query_fields_sanitizer(self) -> None:
		self.assertRaises(
			frappe.DataError,
	...
	def test_nested_permission(self) -> None:
		frappe.set_user("Administrator")
	...
	def test_filter_sanitizer(self) -> None:
		self.assertRaises(
			frappe.DataError,
			DatabaseQuery("DocType").execute,
			fields=["name"],
	...
	def test_order_by_group_by_sanitizer(self) -> None:
	...
	def test_of_not_of_descendant_ancestors(self) -> None:
		frappe.set_user("Administrator")
		clear_user_permissions_for_doctype("Nested DocType")
	...
	def test_is_set_is_not_set(self) -> None:
	...
	def test_set_field_tables(self) -> None:
	...
	def test_virtual_field_get_list(self) -> None:
		try:
	...
	def test_column_comparison(self) -> None:
	...
	def test_permlevel_fields(self) -> None:
	...
	def test_fieldname_starting_with_int(self) -> None:
		from frappe.core.doctype.doctype.test_doctype import new_doctype
	...
	def test_permission_query_condition(self) -> None:
	...
	def test_virtual_doctype(self) -> None:
	...
	def test_coalesce_with_in_ops(self) -> None:
	...
	def test_coalesce_with_datetime_ops(self) -> None:
	...
	def test_ambiguous_linked_tables(self) -> None:
	...
	def test_select_star_expansion(self) -> None:
...
class TestReportView(IntegrationTestCase):
	...
	def test_reportview_get(self) -> None:
	...
	def test_reportview_get_aggregation(self) -> None:
	...
	def test_reportview_get_permlevel_system_users(self) -> None:
		with setup_patched_blog_post(), setup_test_user(set_user=True):
			frappe.local.request = frappe._dict()
			frappe.local.request.method = "POST"
			frappe.local.form_dict = frappe._dict(
	...
	def test_reportview_get_admin(self) -> None:
		# Admin should be able to see access all fields
	...
	def test_db_filter_not_set(self) -> None:
		"""
...
def add_child_table_to_blog_post() -> None:
...
def create_nested_doctype() -> None:
...
def create_nested_doctype_records() -> None:
	"""
