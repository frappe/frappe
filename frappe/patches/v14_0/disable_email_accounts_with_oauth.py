...
def execute():
	if nts.get_all("Email Account", {"auth_method": "OAuth", "connected_user": ["is", "set"]}, limit=1):
		return
	...
	nts.db.set_value("Email Account", {"auth_method": "OAuth"}, "awaiting_password", 1)
...
def get_system_managers():
	user_doctype = nts.qb.DocType("User").as_("user")
	user_role_doctype = nts.qb.DocType("Has Role").as_("user_role")
	return (
