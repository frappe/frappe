import nts
from nts.core.doctype.log_settings.log_settings import clear_log_table
...
def execute():
	...
	ref: https://github.com/nts/nts/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(nts.db.exists(doctype, {"modified": ("<", threshold)}))
