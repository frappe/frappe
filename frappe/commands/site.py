...
@click.option('--db-port', default='3306', help='Database Port')
...
def new_site(site, mariadb_root_username=None, mariadb_root_password=None, admin_password=None,
			 ...
			 db_name=None, db_type=None, db_port=None):
	"Create a new site"
	...
	_new_site(db_name, site, mariadb_root_username=mariadb_root_username,
			  ...
			  db_type=db_type, db_port=db_port)
...
def _new_site(db_name, site, mariadb_root_username=None, mariadb_root_password=None,
			  ...
			  reinstall=False, db_type=None, db_port=None):
	...
	try:
		...
		install_db(root_login=mariadb_root_username, root_password=mariadb_root_password,
				   ...
				   source_sql=source_sql, force=force, reinstall=reinstall, db_type=db_type, db_port=db_port)
