...
@click.option("-ws", "--with-scheduler", default=True, help="If redis scheduler should be started. Default is True.")
def start_worker(queue, quiet=False, rq_username=None, rq_password=None, burst=False, strategy=None, with_scheduler=True):
