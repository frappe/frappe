...
class TestReport(unittest.TestCase):
    def test_report_builder(self):
        ...
        self.assertTrue('System User' in [d[1] for d in data])
    ...
    def test_report_permissions(self):
        frappe.db.sql("""delete from `tabHas Role` where parent = %s and role = 'Test Has Role'""",
                      frappe.session.user, auto_commit=1)
        ...
        self.assertNotEquals(report.is_permitted(), False)
    ...
    def test_balance_sheet(self):
        ...
        self.assertRow(data, 2, 'Bank Accounts', 'INR',  1700.0)
        self.assertRow(data, 3, '_Test Bank', 'INR', 1700.0)
        self.assertRow(data, 4, '_Test Receivable', 'INR', -3600.0)
        ...
        self.assertRow(data, 12, r"'Provisional Profit / Loss (Credit)'", 'INR', -300.0)
    ...
    def test_profit_and_loss_statement(self):
        ...
        self.assertRow(data, 1, '_Test Account Cost for Goods Sold', 'INR', 300.03)
    ...
    def test_cash_flow(self):
        ...
        self.assertRow(data, 3, 'Net Change in Accounts Receivable', 'INR', 3600.00)
        self.assertRow(data, 4, 'Net Change in Accounts Payable', 'INR', -1600.00)
        self.assertRow(data, 5, 'Net Change in Inventory', 'INR')
        self.assertRow(data, 6, r"'Net Cash from Operations'", 'INR', 1699.9700000000003)
        ...
        self.assertRow(data, 16, r"'Net Change in Cash'", 'INR', 1699.9700000000003)
...
#        01-01-2013 12-31-2013
        self.assertEqual(data[0], {u'closing_credit': 0.0, u'account': u'Application of Funds (Assets) - _TC', u'indent': 0, u'credit': 5500.0, u'opening_debit': 0.0, u'closing_debit': -1900.0, u'parent_account': None, u'currency': u'INR', u'from_date': datetime.date(2013, 1, 1), u'has_value': True, u'to_date': datetime.date(2013, 12, 31), u'debit': 3600.0, u'opening_credit': 0.0, u'account_name': u'Application of Funds (Assets)'})
        ...
        self.assertEqual(data[2], {u'closing_credit': 0.0, u'account': u'Bank Accounts - _TC', u'indent': 2, u'credit': 1900.0, u'opening_debit': 0.0, u'closing_debit': 1700.0, u'parent_account': u'Current Assets - _TC',
        ...
        self.assertEqual(data[3], {u'closing_credit': 0.0, u'account': u'_Test Bank - _TC', u'indent': 3, u'credit': 1900.0, u'opening_debit': 0.0, u'closing_debit': 1700.0, u'parent_account': u'Bank Accounts - _TC',
        ...
        self.assertEqual(data[4], {u'closing_credit': 0.0, u'account': u'_Test Receivable - _TC', u'indent': 2, u'credit': 3600.0, u'opening_debit': 0.0, u'closing_debit': -3600.0, u'parent_account': u'Current Assets - _TC',
        ...
        self.assertEqual(data[9], {u'closing_credit': 0.0, u'account': u'Indirect Expenses - _TC', u'indent': 1, u'credit': 0.03, u'opening_debit': 0.0, u'closing_debit': -0.03, u'parent_account': u'Expenses - _TC',
        ...
        self.assertEqual(data[10], {u'closing_credit': 0.0, u'account': u'_Test Write Off - _TC', u'indent': 2, u'credit': 0.03, u'opening_debit': 0.0, u'closing_debit': -0.03, u'parent_account': u'Indirect Expenses - _TC',
        ...
        self.assertEqual(data[11], {u'closing_credit': 0.0, u'account': u'_Test Account Cost for Goods Sold - _TC', u'indent': 1, u'credit': 0.0, u'opening_debit': 0.0, u'closing_debit': 300.03, u'parent_account': u'Expenses - _TC',
        ...
        self.assertEqual(data[13], {u'closing_credit': -1600.0, u'opening_credit': 0.0, u'parent_account': None, u'currency': u'INR', u'closing_debit': -1600.0, u'account_name': r"'Total'", u'account': r"'Total'", u'indent': 0, u'has_value': True, u'opening_debit': 0.0, u'warn_if_negative': True, u'credit': 5500.03, u'debit': 5500.03})
        self.assertEqual(len(data), 14)
    ...
    def test_accounts_receivable(self):
        ...
        expected = [datetime.date(2013, 2, 14), u'_Test Customer', u'Journal Entry', 400.0, -400.0, u'INR', -400.0, u'_Test Territory', u'_Test Customer Group', u'Note: test\nReference #33 dated 03-14-2013']
    ...
    def test_accounts_payable(self):
        ...
        index = self.get_index(fieldnames, columns)
        actual = self.get_elements(data[0], index)
        expected = [datetime.date(2013, 2, 14), u'_Test Supplier', u'Journal Entry', 400.0, -400.0, 'INR', -400.0, u'_Test Supplier Group', u'Note: test\nReference #33 dated 02-14-2013\n\u20b9 0.00 against Purchase Order PUR-ORD-2018-00001']
        self.assertEqual(actual,expected)
        self.assertEqual(len(data), 5)
    ...
    def test_accounts_receivable_summary(self):
        ...
        columns, data = report.get_data(filters={'company': '_Test Company'})
        self.assertEqual(report.report_type, 'Script Report')
        self.assertEqual(data[0], [u'_Test Customer USD', 10000.0, 51320.0, 0.0, -41320.0, -28740.0, 0.0, -12580.0, 0.0, u'_Test Territory', u'_Test Customer Group', u'INR'])
    ...
    def test_accounts_payable_summary(self):
        ...
        columns, data = report.get_data(filters={'company': '_Test Company'})
        self.assertEqual(report.report_type, 'Script Report')
        self.assertEqual(data[0], [u'_Test Supplier', 0.0, 1600.0, 0.0, -1600.0, 0.0, 0.0, 0.0, -1600.0, u'_Test Supplier Group', u'INR'])
        self.assertEqual(data[1], [u"'Total'", u'', 1600.0, u'', -1600.0, u'', u'', u'', -1600.0, u'', u'INR'])
