...
def update_comments_in_parent(reference_doctype, reference_name, _comments):
	...
	if not reference_doctype or not reference_name or frappe.db.get_value("DocType", reference_doctype, "issingle") or frappe.db.get_value("DocType", reference_doctype, "virtual_doctype"):
		return
