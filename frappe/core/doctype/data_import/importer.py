...
class ImportFile:
	...
	def parse_data_from_template(self):
		...
		if len(data) > 5000:
			frappe.msgprint("""For optimal site performance, please upload only up to 5,000 records.
				To import more data, you can use smaller files to import them individually.""")
