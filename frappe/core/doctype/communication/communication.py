...
from frappe.utils import validate_email_address, strip_html, cstr, time_diff_in_seconds, get_datetime
...
def update_first_response_time(parent, communication):
	if parent.meta.has_field("first_response_time") and not parent.get("first_response_time"):
		if is_system_user(communication.sender):
			...
			first_response_time = calculate_first_response_time(parent, get_datetime(first_responded_on))
