...
def install_db(root_login="root", root_password=None, db_name=None, source_sql=None,
			   ...
			   db_type=None, db_port=None):

	if not db_type:
		db_type = frappe.conf.db_type or 'mariadb'

	make_conf(db_name, site_config=site_config, db_type=db_type, db_port=db_port)
...
def make_conf(db_name=None, db_password=None, site_config=None, db_type=None, db_port=None):
	site = frappe.local.site
	make_site_config(db_name, db_password, site_config, db_type=db_type, db_port=db_port)
	sites_path = frappe.local.sites_path
	frappe.destroy()
	frappe.init(site, sites_path=sites_path)

def make_site_config(db_name=None, db_password=None, site_config=None, db_type=None, db_port=None):
