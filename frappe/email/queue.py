...
from frappe.utils import add_to_date, cint, cstr, get_url, now_datetime
...
def get_queue():
	...
	# Exclude emails created within the last 7 seconds to allow time for undo
	undo_window = add_to_date(now_datetime(), seconds=-7)
