...
class TestInboundMail(FrappeTestCase):
	...
	def test_decode_header(self):
		...
		communication = inbound_mail.process()
		todo = self.new_todo(sender="test_sender@example.com", description=communication.subject)

		print("Decoded subject: " + communication.subject)
		self.assertEqual(communication.reference_doctype, "ToDo")
		self.assertEqual(todo.description, communication.subject)
		self.assertTrue(communication.reference_name)
