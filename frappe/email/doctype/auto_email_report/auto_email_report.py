...
from frappe.desk.query_report import build_xlsx_data, get_xlsx_styles
	...
	def get_report_content(self):
		...
		if self.format == "HTML":
			...
			report_data = frappe._dict(
				{"report_name": self.report, "columns": columns, "result": data, "_filters": self.filters}
			)
