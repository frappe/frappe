...
class LoginManager:
	...
	def login(self):
		...
		if self.force_user_to_reset_password():
			...
			frappe.local.response["redirect_to"] = doc.reset_password(send_email=False)
