...
class TestAutoAssign(unittest.TestCase):
	...
	def test_assignment_rule_condition(self):
		...
		self.assertEqual(str(frappe.utils.getdate(note1_todo_doc.date)), expiry_date)
		...
		self.assertEqual(str(frappe.utils.getdate(note1_todo_doc.date)), note1.expiry_date)
		...
		self.assertNotEqual(str(frappe.utils.getdate(note1_todo_doc.date)), note1.expiry_date)
		self.assertEqual(str(frappe.utils.getdate(note1_todo_doc.date)), expiry_date)
