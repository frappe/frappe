...
class TestAutoAssign(unittest.TestCase):
	...
	def test_assignment_rule_condition(self):
		...
		self.assertEqual(frappe.utils.get_date_str(note1_todo_doc.date), frappe.utils.get_date_str(expiry_date))
		...
		self.assertEqual(frappe.utils.get_date_str(note1_todo_doc.date), frappe.utils.get_date_str(note1.expiry_date))
		...
		self.assertNotEqual(frappe.utils.get_date_str(note2_todo.date), frappe.utils.get_date_str(note1.expiry_date))
		self.assertEqual(frappe.utils.get_date_str(note2_todo.date), frappe.utils.get_date_str(expiry_date))
