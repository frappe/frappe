...
# `make_mapped_doc` and `map_docs` moved to frappe.core.api.document; aliases
# keep the old dotted paths and importers working.
from frappe.core.api.document import make_mapped_doc, map_docs
