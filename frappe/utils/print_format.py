...
def read_multi_pdf(output):
	...
	Returns:
		bytes: The content of the merged pdf files.
	"""
	# Get the content of the merged pdf files
...
def download_pdf(
	...
	Args:
		doctype (str): The doctype of the document to be printed.
		name (str): The name of the document to be printed.
		format (str, optional): The format of the document. Defaults to None.
		doc (dict, optional): The document object. Defaults to None.
		no_letterhead (int, optional): Flag to exclude letterhead. Defaults to 0.
		language (str, optional): The language of the document. Defaults to None.
...
def report_to_pdf(html, orientation="Landscape"):
	"""
	Generate a pdf file from an html content.

	Args:
		html (str): The html content.
		orientation (str, optional): The orientation of the pdf. Defaults to "Landscape".
	"""
...
def print_by_server(
	...
	"""
	Print a document using a network printer.

	This function takes several arguments, including:
		- doctype: The type of the document to print.
		- name: The name of the document to print.
		- printer_setting: The name of the printer settings document to use.
		- print_format: The name of the print format to use.
		- doc: The document object to print.
		- no_letterhead: A flag indicating whether to include the letterhead in the printout.
		- file_path: The path to save the generated PDF file.

	The function retrieves the print settings from the 'Network Printer Settings'
	document using the frappe.get_doc function. It then tries to import the
	cups module and sets the server IP and port based on the print settings. A
	cups.Connection object is created, and a PdfWriter object is initialized.
	The frappe.get_print function is called to generate a PDF output using the
	given arguments and the output object. If no file path is provided, a
	temporary file path is generated. The PDF output is written to the file
	path, and then the conn.printFile method is called to print the file using
	the printer name from the print settings. Exceptions are caught for
	OSError and cups.IPPError, and appropriate error messages are thrown.
	"""
