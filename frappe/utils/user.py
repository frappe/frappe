...
class UserPermissions:
	...
	def build_doctype_map(self):
		...
		table = builder.get_reflection('tabDocType')

		q = select(table.c.name, table.c.in_create, table.c.issingle, table.c.istable, table.c.read_only,
		table.c.restrict_to_domain, table.c.module)

		query = builder.get_values(q)
		for r in frappe.db.sql(query, as_dict=1):
