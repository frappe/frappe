...
from frappe.doctypes import User, UTMCampaign, UTMMedium, UTMSource
...
def get_user_info_for_avatar(user_id: str) -> _UserInfo:
	...
	"""
	try:
		user = User.docs.get(user_id, cached=True)
