...
def add_to_date(date, years=0, months=0, weeks=0, days=0, hours=0, seconds=0, as_string=False, as_datetime=False):
	...
	date = date + relativedelta(years=years, months=months, weeks=weeks, days=days, hours=hours, seconds=seconds)
