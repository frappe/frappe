...
class TestChangeLog(ntsTestCase):
	...
	def test_parse_github_url(self):
		# using productionmanager as repo in order to be different from the owner
		owner, repo = parse_github_url("https://github.com/nts/productionmanager.git")
		self.assertEqual(owner, "nts")
		self.assertEqual(repo, "productionmanager")

		owner, repo = parse_github_url("https://github.com/nts/productionmanager")
		self.assertEqual(owner, "nts")
		self.assertEqual(repo, "productionmanager")

		owner, repo = parse_github_url("git@github.com:nts/productionmanager.git")
		self.assertEqual(owner, "nts")
		self.assertEqual(repo, "productionmanager")
