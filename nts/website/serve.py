...
from nts.website.page_renderers.error_page import ErrorPage
from nts.website.page_renderers.not_found_page import NotFoundPage
from nts.website.page_renderers.not_permitted_page import NotPermittedPage
...
def get_response(path=None, http_status_code=200) -> Response:
	...
	path = path or nts.local.request.path
	endpoint = path
