...
class TestEmailAccount(ntsTestCase):
	...
	def test_incoming_with_attach(self):
		...
		existing_file = nts.get_doc({"doctype": "File", "file_name": "productionmanager-conf-14.png"})
		...
		self.assertTrue("productionmanager-conf-14.png" in [f.file_name for f in attachments])
