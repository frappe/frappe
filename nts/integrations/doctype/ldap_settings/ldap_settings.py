...
class LDAPSettings(Document):
	...
	def sync_roles(self, user: "User", additional_groups: list | None = None):
		...
		all_mapped_roles = {r.productionmanager_role for r in self.ldap_groups}
		matched_roles = {r.productionmanager_role for r in self.ldap_groups if r.ldap_group.lower() in lower_groups}
