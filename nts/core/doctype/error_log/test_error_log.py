...
_RAW_EXC = """
   ...
   File "apps/nts/nts/model/document.py", line 933, in fn
     return method_object(*args, **kwargs)
            ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   File "apps/productionmanager/productionmanager/selling/doctype/sales_order/sales_order.py", line 58, in onload
...
class TestExceptionSourceGuessing(ntsTestCase):
	@patch.object(nts, "get_installed_apps", return_value=["nts", "productionmanager", "3pa"])
